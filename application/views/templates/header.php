...
<html>
	<head>
    	...
    	<link rel="stylesheet" type="text/css" href="<?php echo base_url('includes/semantic/dist/semantic.min.css'); ?>">
    	<script type="text/javascript" src="<?php echo base_url('includes/semantic/jquery.min.js'); ?>"></script>
...
<body>
	...
	<div class="ui main header" style="background: url('<?php echo base_url('includes/images/header.jpg'); ?>');background-repeat: no-repeat; background-size: 100%;">
		<div id="">
			<?php
			if (isset($this->session->userdata['isLoggedIn']) && $this->session->userdata['isLoggedIn'] == TRUE) { ?> 
				<div class="ui simple right floated dropdown button" id="log_buttons">
			...
			<div class="ui ten compact menu buttons">
				<div class="ui container">
					...
					<div class="ui simple olive dropdown button">
						...
						<div class="ui menu">
							<a href="/ECE/index.php/CompetitiveExams/exams/gate" class="simple dropdown item">GATE</a>
							<a href="/ECE/index.php/CompetitiveExams/exams/ies" class="simple dropdown item">IES</a>
							<a href="/ECE/index.php/CompetitiveExams/exams/isro" class="simple dropdown item">ISRO</a>
							<a href="/ECE/index.php/CompetitiveExams/exams/jto" class="simple dropdown item">JTO</a>
						</div>
					</div>
